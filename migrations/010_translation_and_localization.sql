-- Consolidated migration: 010_translation_and_localization.sql
-- Generated from active source migrations retained after cleanup

-- ============================================================================
-- Source: add_translation_system.sql
-- ============================================================================
...
CREATE TABLE IF NOT EXISTS supported_languages (
  ...
  flag_emoji TEXT,                  -- '­ƒç¼­ƒçº', '­ƒçº­ƒçÀ'
...
('en', 'English', 'English', '­ƒç¼­ƒçº', true, true, 1),
('pt-PT', 'Portugu├¬s', 'Portugu├¬s (Portugal)', '­ƒçÁ­ƒç╣', true, false, 2)
...
('ui', NULL, 'nav_settings', 'pt-PT', 'Settings', 'Defini├º├Áes', false, true),
...
('ui', NULL, 'label_rank', 'pt-PT', 'Rank', 'Posi├º├úo', false, true),
('ui', NULL, 'label_price', 'pt-PT', 'Price', 'Pre├ºo', false, true),
...
('ui', NULL, 'label_description', 'pt-PT', 'Description', 'Descri├º├úo', false, true),
...
('ui', NULL, 'label_no', 'pt-PT', 'No', 'N├úo', false, true),
...
('ui', NULL, 'label_free', 'pt-PT', 'Free', 'Gr├ítis', false, true),
...
('ui', NULL, 'label_daily', 'pt-PT', 'Daily', 'Di├írio', false, true),
...
('ui', NULL, 'label_tomorrow', 'pt-PT', 'Tomorrow', 'Amanh├ú', false, true),
...
('ui', NULL, 'label_information', 'pt-PT', 'Information', 'Informa├º├úo', false, true),
...
('ui', NULL, 'msg_action_cancelled', 'pt-PT', 'Action cancelled', 'A├º├úo cancelada', false, true),
...
('ui', NULL, 'msg_connection_error', 'pt-PT', 'Connection error', 'Erro de liga├º├úo', false, true),
('ui', NULL, 'msg_session_expired', 'pt-PT', 'Session expired', 'Sess├úo expirada', false, true),
('ui', NULL, 'msg_please_login', 'pt-PT', 'Please login', 'Por favor, inicia sess├úo', false, true),
('ui', NULL, 'msg_access_denied', 'pt-PT', 'Access denied', 'Acesso negado', false, true),
('ui', NULL, 'msg_not_found', 'pt-PT', 'Not found', 'N├úo encontrado', false, true),
('ui', NULL, 'msg_coming_soon', 'pt-PT', 'Coming soon', 'Em breve', false, true),
('ui', NULL, 'msg_under_maintenance', 'pt-PT', 'Under maintenance', 'Em manuten├º├úo', false, true),
...
('ui', NULL, 'msg_inventory_full', 'pt-PT', 'Inventory full', 'Invent├írio cheio', false, true),
...
('ui', NULL, 'nav_vouchers', 'pt-PT', 'Vouchers', 'Cup├Áes', false, true),
('ui', NULL, 'nav_daily_wheel', 'pt-PT', 'Daily Wheel', 'Roda Di├íria', false, true),
...
('ui', NULL, 'nav_voucher_manager', 'pt-PT', 'Voucher Manager', 'Gestor de Cup├Áes', false, true),
...
('ui', NULL, 'nav_notifications', 'pt-PT', 'Notifications', 'Notifica├º├Áes', false, true),
...
('ui', NULL, 'nav_leaderboards', 'pt-PT', 'Leaderboards', 'Tabelas de Classifica├º├úo', false, true),
...
('ui', NULL, 'nav_stream', 'pt-PT', 'Stream', 'Transmiss├úo', false, true),
...
('ui', NULL, 'time_ago', 'pt-PT', 'ago', 'atr├ís', false, true),
...
('ui', NULL, 'form_sign_in', 'pt-PT', 'Sign In', 'Iniciar Sess├úo', false, true),
('ui', NULL, 'form_sign_out', 'pt-PT', 'Sign Out', 'Terminar Sess├úo', false, true),
...
('ui', NULL, 'validation_email', 'pt-PT', 'Please enter a valid email', 'Por favor, introduz um email v├ílido', false, true),
('ui', NULL, 'validation_min_length', 'pt-PT', 'Minimum length not met', 'Comprimento m├¡nimo n├úo atingido', false, true),
('ui', NULL, 'validation_max_length', 'pt-PT', 'Maximum length exceeded', 'Comprimento m├íximo excedido', false, true),
('ui', NULL, 'validation_passwords_match', 'pt-PT', 'Passwords must match', 'As palavras-passe devem coincidir', false, true),
('ui', NULL, 'validation_invalid', 'pt-PT', 'Invalid value', 'Valor inv├ílido', false, true),
...
('ui', NULL, 'casino_max_bet', 'pt-PT', 'Max Bet', 'Aposta M├íx.', false, true),
...
('ui', NULL, 'casino_auto_play', 'pt-PT', 'Auto Play', 'Jogo Autom├ítico', false, true),
('ui', NULL, 'casino_free_spins', 'pt-PT', 'Free Spins', 'Rodadas Gr├ítis', false, true),
...
('ui', NULL, 'profile_posts', 'pt-PT', 'Posts', 'Publica├º├Áes', false, true),

-- Errors
('ui', NULL, 'error_404', 'pt-PT', 'Page not found', 'P├ígina n├úo encontrada', false, true),
...
('ui', NULL, 'error_unauthorized', 'pt-PT', 'Unauthorized', 'N├úo autorizado', false, true),
