...
| Bonus Hunt | `v12_classic_sr_editable` | Done | n/a | Done | Done | Uses V12 renderer | Partial | Legacy prefixed CSS | Done | Done | Done | Done | Done | Done | Pending | Visible for testing | Structural carousel/list dimensions remain locked. |
