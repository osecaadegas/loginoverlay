...
export const GAME_PROVIDERS = [
  { id: 'pragmatic-play', name: 'Pragmatic Play', slug: 'pragmatic-play', image: '/providers/pragmatic_play.png' },
...
const PROVIDER_ALIASES = {
  '4theplayer': '4_the_player',
  '4_the_player': '4_the_player',
  '3_oaks': '3oaks',
  'aceroll': 'aceroll',
  'amigo': 'amigogaming',
  'amigo_gaming': 'amigogaming',
  'apollo': 'apollo_games',
  'apollo_game': 'apollo_games',
  'apollo_games': 'apollo_games',
  'arcadem': 'arcadem',
  'avatar_ux': 'avatarux',
  'backseat': 'backseat_gaming',
  'backseat_gaming': 'backseat_gaming',
  'bang_bang': 'bang_bang_games',
  'bang_bang_games': 'bang_bang_games',
  'bullshark': 'bullshark_gaming',
  'bullshark_gaming': 'bullshark_gaming',
  'clawbuster': 'claw_buster',
  'claw_buster': 'claw_buster',
  'clutch': 'clutch_gaming',
  'clutch_gaming': 'clutch_gaming',
  'gamebeat': 'game_beat',
  'game_beat': 'game_beat',
  ...
  'jinx': 'jinx_gaming',
  'jinx_gaming': 'jinx_gaming',
  'kitsune': 'kitsune',
  'light_and_wonder': 'light_wonder',
  'light_wonder': 'light_wonder',
  'now_now_gaming': 'nownow_gaming',
  'nownow': 'nownow_gaming',
  'nownow_gaming': 'nownow_gaming',
  'net_ent': 'netent',
  'nolimit_city': 'nolimit',
  'no_limit_city': 'nolimit',
  'octo_play': 'octoplay',
  'octoplay': 'octoplay',
  'pinguin': 'pinguin_king',
  'pinguin_king': 'pinguin_king',
  'play_n_go': 'playngo',
  'playn_go': 'playngo',
  'playngo': 'playngo',
  'print': 'print_studio',
  'print_studio': 'print_studio',
  'play_pearls': 'playpearls',
  ...
  'ruby_play': 'rubyplay',
  'scientific_games': 'sg_digital',
  'scientific_games_digital': 'sg_digital',
  'sg': 'sg_digital',
  'sg_digital': 'sg_digital',
