...
export default function SpotifyWidgetDisplay() {
  ...
  if (!settings?.enabled) {
    return (
      <div className="spotify-widget-display" style={{ padding: '20px', color: '#9ca3af', fontSize: '14px', textAlign: 'center' }}>
        Widget is disabled. Enable it in settings.
      </div>
    );
  }
  ...
  const renderLayout = () => {
    ...
    if (!currentTrack) {
      return (
        <div className="spotify-widget-content layout-placeholder">
          ...
          <div className="placeholder-text">
            ...
            <div style={{fontSize: '12px', opacity: 0.7, marginTop: '4px'}}>Play something on Spotify</div>
          </div>
        </div>
      );
    }
