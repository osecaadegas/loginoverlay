...
function RoutesPanel() {
  const routes = [
    ...
    { path: '/obs/overlay/:publicOverlayId', desc: 'Better OBS overlay renderer', access: 'Public' },
    { path: '/obs/overlay/:publicOverlayId/widget/:instanceId', desc: 'Better individual widget renderer', access: 'Public' },
