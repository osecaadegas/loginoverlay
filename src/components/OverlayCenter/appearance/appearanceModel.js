...
const WIDGET_SUB_ELEMENT_DEFINITIONS = {
  bonus_hunt: [
    ...
    { id: 'slotCarouselContainer', label: 'Slot carousel container', properties: ['padding', 'gap'] },
    { id: 'carouselBackdrop', label: 'Carousel backing box', properties: ['background', 'borderColor', 'borderWidth', 'radius', 'shadow', 'opacity'] },
    ...
    { id: 'resultCard', label: 'Best / Worst cards', properties: ['background', 'borderColor', 'borderWidth', 'radius', 'padding', 'gap'] },
    ...[
      ['resultLabel', 'Best / Worst labels'],
      ['resultTitle', 'Best / Worst slot names'],
      ['resultPayout', 'Best / Worst payouts'],
      ['resultStatLabel', 'Best / Worst stat labels'],
      ['resultStatValue', 'Best / Worst stat values'],
    ].map(([id, label]) => ({ id, label, properties: ['textColor', 'fontFamily', 'fontSize', 'fontWeight'] })),
    ...
    { id: 'rowStatsContainer', label: 'Row stats area', properties: ['background', 'borderColor', 'borderWidth', 'radius', 'padding', 'opacity'] },
  ...
  bets: [
    ...
    { id: 'widgetBackground', label: 'Widget background', properties: ['background', 'textColor', 'accentColor', 'borderColor', 'borderWidth', 'radius', 'padding', 'gap', 'opacity', 'shadow', ...COMMON_TEXT_PROPERTIES] },
    { id: 'header', label: 'Header', properties: ['background', 'textColor', 'borderColor', 'borderWidth', ...COMMON_TEXT_PROPERTIES, 'padding', 'radius', 'shadow', 'opacity'] },
    { id: 'status', label: 'Status badge', properties: ['background', 'textColor', ...COMMON_TEXT_PROPERTIES, 'padding', 'radius'] },
    { id: 'poolStat', label: 'Pool stat', properties: ['background', 'textColor', 'accentColor', ...COMMON_TEXT_PROPERTIES, 'padding', 'radius', 'borderColor', 'borderWidth'] },
    { id: 'timerStat', label: 'Timer stat', properties: ['background', 'textColor', 'accentColor', ...COMMON_TEXT_PROPERTIES, 'padding', 'radius', 'borderColor', 'borderWidth'] },
    { id: 'betsStat', label: 'Bets stat', properties: ['background', 'textColor', 'accentColor', ...COMMON_TEXT_PROPERTIES, 'padding', 'radius', 'borderColor', 'borderWidth'] },
    { id: 'betCards', label: 'Bet cards', properties: ['background', 'textColor', 'borderColor', 'borderWidth', 'radius', 'padding', 'gap', 'shadow', 'opacity'] },
    { id: 'individualBetCard', label: 'Individual bet card', properties: ['background', 'textColor', 'borderColor', 'borderWidth', 'radius', 'padding', 'gap', 'shadow', 'opacity'] },
    { id: 'cardNumberBadge', label: 'Card number badge', properties: ['background', 'textColor', 'accentColor', ...COMMON_TEXT_PROPERTIES, 'radius'] },
