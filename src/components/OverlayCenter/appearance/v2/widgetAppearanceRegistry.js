...
export const widgetAppearanceRegistry = Object.freeze({
  ...
  chat: makeBasicWidgetCapability({
    ...
    styles: [
      ...
      makeRuntimeStyle(
        "better_chat",
        "Better Chat",
        "Blue-and-gold live chat panel with card messages and avatar initials.",
        {
          capabilities: {
            rows: true,
            statCards: true,
  ...
  bets: Object.freeze({
    ...
    styles: Object.freeze([
      ...
      freezeStyle({
        ...
        label: "Better Bets",
        description:
          "Blue-and-gold betting board with live pool, timer, entries and card fill states.",
        capabilities: {
          ...BASE_QUICK_CAPABILITIES,
          progressBar: true,
          positiveNegativeColours: true,
  ...
  rtp_stats: Object.freeze({
    ...
    styles: Object.freeze([
      ...
      freezeStyle({
        ...
        label: "Better RTP",
        description:
          "Blue-and-gold RTP strip using the current resolved slot, provider and personal best data.",
        capabilities: {
          ...BASE_QUICK_CAPABILITIES,
          images: true,
          statCards: true,
  ...
  navbar: Object.freeze({
    ...
    styles: Object.freeze([
      ...
      freezeStyle({
        ...
        label: "Better Navbar",
        description:
          "Blue-and-gold stream navbar shell for identity, clock, music, balance, casino and CTA data.",
        capabilities: {
          ...BASE_QUICK_CAPABILITIES,
          images: true,
          imageSize: true,
  ...
  bonus_hunt: Object.freeze({
    ...
    styles: Object.freeze([
      ...
      freezeStyle({
        id: "better_bonus_hunt",
        label: "Better Hunt",
        description:
          "Blue-and-gold Bonus Hunt panel using the saved bonus list, opening state and payout stats.",
        capabilities: {
          ...BASE_QUICK_CAPABILITIES,
          ...IMAGE_QUICK_CAPABILITIES,
          carousel: true,
  ...
  background: Object.freeze({
    ...
    styles: Object.freeze([
      ...
      freezeStyle({
        id: "better_background",
        label: "Better Background",
        description:
          "Layered animated stream background with texture colours, optional media and effects.",
        capabilities: {
          colours: true,
          multipleColours: true,
          containers: true,
  ...
  giveaway: Object.freeze({
    ...
    styles: Object.freeze([
      ...
      freezeStyle({
        ...
        description:
          "Blue-and-gold giveaway console using the real participants, keyword, prize and winner state.",
        capabilities: {
          ...BASE_QUICK_CAPABILITIES,
          statCards: true,
          positiveNegativeColours: true,
