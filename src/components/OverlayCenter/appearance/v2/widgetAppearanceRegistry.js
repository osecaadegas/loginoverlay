...
export const widgetAppearanceRegistry = Object.freeze({
  ...
  chat: makeBasicWidgetCapability({
    ...
    styles: [
      ...
      makeRuntimeStyle('StyleSecaChat', 'StyleSeca Chat', 'Two-colour hunt chat panel with glowing raid and follower highlights.', { capabilities: { rows: true, statCards: true, shadows: true, glow: true, glowIntensity: true, barDimensions: true }, elementIds: ['container', 'header', 'messageList', 'message', 'username', 'messageText', 'avatar', 'badge', 'highlightedMessage'] }),
  ...
  rtp_stats: Object.freeze({
    ...
    styles: Object.freeze([
      ...
      freezeStyle({
        id: 'StyleSecaRTP',
        label: 'StyleSeca RTP',
        description: 'Compact two-colour hunt RTP bar with metallic glow accents.',
        capabilities: {
          ...BASE_QUICK_CAPABILITIES,
          images: true,
          statCards: true,
  ...
  navbar: Object.freeze({
    ...
    styles: Object.freeze([
      ...
      freezeStyle({
        id: 'StyleSecaNav',
        label: 'StyleSeca Nav',
        description: 'Two-colour hunt navbar with metallic texture, glow accents and controlled CTA/name colours.',
        capabilities: {
          ...BASE_QUICK_CAPABILITIES,
          images: true,
          imageSize: true,
