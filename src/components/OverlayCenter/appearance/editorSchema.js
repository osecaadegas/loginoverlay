...
export const CONTROL_DEFINITIONS = {
  ...
  bgMode: { id: 'bgMode', label: 'Source', type: 'segmented', options: [
    { value: 'texture', label: 'Texture' },
    { value: 'image', label: 'Image URL' },
    { value: 'video', label: 'Video URL' },
    { value: 'special', label: 'Animated' },
  ], simple: true, group: 'Background' },
  textureType: { id: 'textureType', label: 'Texture', type: 'select', options: [
  ...
  videoUrl: { id: 'videoUrl', label: 'Video URL', type: 'text', group: 'Image' },
  ...
  patternSize: { id: 'patternSize', label: 'Pattern size', type: 'range', min: 4, max: 120, step: 1, unit: 'px', group: 'Background' },
  animSpeed: { id: 'animSpeed', label: 'Animation speed', type: 'range', min: 2, max: 30, step: 1, unit: 's', group: 'Background' },
  ...
  musicDisplayStyle: { id: 'musicDisplayStyle', label: 'Spotify style', type: 'select', options: [
  ...
  brightness: { id: 'brightness', label: 'Brightness', type: 'range', min: 0, max: 200, step: 1, unit: '%', group: 'Effects' },
  contrast: { id: 'contrast', label: 'Contrast', type: 'range', min: 0, max: 200, step: 1, unit: '%', group: 'Effects' },
  saturation: { id: 'saturation', label: 'Saturation', type: 'range', min: 0, max: 200, step: 1, unit: '%', group: 'Effects' },
  hueRotate: { id: 'hueRotate', label: 'Hue rotate', type: 'range', min: 0, max: 360, step: 1, unit: 'deg', group: 'Effects' },
  grayscale: { id: 'grayscale', label: 'Grayscale', type: 'range', min: 0, max: 100, step: 1, unit: '%', group: 'Effects' },
  sepia: { id: 'sepia', label: 'Sepia', type: 'range', min: 0, max: 100, step: 1, unit: '%', group: 'Effects' },
  fxParticles: { id: 'fxParticles', label: 'Particles', type: 'select', options: ['none', 'orbs', 'fireflies', 'bokeh', 'snow', 'rain'], simple: true, group: 'Effects' },
  fxParticleColor: { id: 'fxParticleColor', label: 'Particle color', type: 'color', group: 'Effects' },
  fxParticleCount: { id: 'fxParticleCount', label: 'Particle count', type: 'range', min: 5, max: 80, step: 1, group: 'Effects' },
  fxParticleSpeed: { id: 'fxParticleSpeed', label: 'Particle speed', type: 'range', min: 0, max: 100, step: 1, unit: '%', group: 'Effects' },
  fxParticleSize: { id: 'fxParticleSize', label: 'Particle size', type: 'range', min: 10, max: 100, step: 1, unit: '%', group: 'Effects' },
  fxFog: { id: 'fxFog', label: 'Fog', type: 'select', options: ['none', 'light', 'medium', 'heavy'], simple: true, group: 'Effects' },
  fxFogColor: { id: 'fxFogColor', label: 'Fog color', type: 'color', group: 'Effects' },
  fxGlimpse: { id: 'fxGlimpse', label: 'Light effect', type: 'select', options: ['none', 'sweep', 'pulse', 'flicker'], simple: true, group: 'Effects' },
  fxGlimpseColor: { id: 'fxGlimpseColor', label: 'Light color', type: 'color', group: 'Effects' },
  fxGlimpseSpeed: { id: 'fxGlimpseSpeed', label: 'Light speed', type: 'range', min: 0, max: 100, step: 1, unit: '%', group: 'Effects' },
