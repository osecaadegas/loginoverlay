...
export default function BonusBuysConfig({ config, onChange, allWidgets, mode }) {
  ...
  const S = {
    ...
    input: { width: '100%', padding: '8px 10px', background: 'rgba(255,255,255,0.06)', border: '1px solid rgba(255,255,255,0.1)', borderRadius: 8, color: '#fff', fontSize: '0.82rem', boxSizing: 'border-box' },
    select: { width: '100%', padding: '8px 10px', background: 'rgba(255,255,255,0.06)', border: '1px solid rgba(255,255,255,0.1)', borderRadius: 8, color: '#fff', fontSize: '0.82rem', boxSizing: 'border-box' },
