...
registerWidget({
  ...
  styles: [
    ...
    { id: "better_bonus_hunt", icon: "B", label: "Better Hunt" },
  ],
...
registerWidget({
  ...
  styles: [
    ...
    { id: "better_giveaway", icon: "B", label: "Better Giveaway" },
  ],
  styleConfigKey: "displayStyle",
  appearanceCapabilities: {
    customTokens: BASIC_WIDGET_APPEARANCE_TOKENS,
...
registerWidget({
  ...
  styles: [
    ...
    { id: "better_navbar", icon: "B", label: "Better Navbar" },
...
registerWidget({
  ...
  styles: [
    ...
    { id: "better_chat", icon: "B", label: "Better Chat" },
    { id: "bh_stats", icon: "🎰", label: "Hunt" },
  ],
...
registerWidget({
  ...
  styles: [
    ...
    { id: "better_rtp", icon: "B", label: "Better RTP" },
    { id: "vertical", icon: "📋", label: "Vertical" },
    { id: "neon", icon: "💡", label: "Neon" },
    { id: "minimal", icon: "✦", label: "Minimal" },
    { id: "glass", icon: "🪟", label: "Glass" },
...
registerWidget({
  ...
  styles: [
    ...
    { id: "better_background", icon: "B", label: "Better Background" },
  ],
  styleConfigKey: "displayStyle",
  appearanceCapabilities: {
    customTokens: [
...
registerWidget({
  ...
  icon: "📋",
  description:
    "Chat viewers request slots with !sr — displays queue with images",
  category: "stream",
...
registerWidget({
  ...
  icon: "📊",
  description:
    "Standalone bonus hunt stats panel — BE, AVG, progress, best/worst payout",
  category: "casino",
