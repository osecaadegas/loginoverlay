...
registerWidget({
  ...
  styles: [{ id: "better_bonus_hunt", icon: "BH", label: "Better Hunt" }],
  defaults: {
...
registerWidget({
  ...
  styleConfigKey: "displayStyle",
  styles: [{ id: "better_giveaway", icon: "GW", label: "Better Giveaway" }],
  defaults: {
...
registerWidget({
  ...
  styleConfigKey: "displayStyle",
  styles: [{ id: "better_navbar", icon: "NB", label: "Better Navbar" }],
  defaults: {
...
registerWidget({
  ...
  styles: [{ id: "better_chat", icon: "CH", label: "Better Chat" }],
  defaults: {
...
registerWidget({
  ...
  styleConfigKey: "displayStyle",
  styles: [{ id: "better_rtp", icon: "RT", label: "Better RTP Stats" }],
  defaults: {
...
registerWidget({
  ...
  styleConfigKey: "displayStyle",
  styles: [{ id: "better_background", icon: "BG", label: "Better Background" }],
  defaults: {
...
registerWidget({
  ...
  styleConfigKey: "displayStyle",
  styles: [{ id: "better_bets", icon: "BT", label: "Better Bets" }],
  defaults: {
