...
export default function BonusHuntWidgetV12({ // NOSONAR - legacy V12 renderer split should be handled as a dedicated visual refactor
  ...
  const clearSrTimers = () => {
    srTimers.current.forEach(clearTimeout);
    srTimers.current = [];
  };
  ...
  const explicitAppearanceConfig = Object.hasOwn(
    c,
  ...
  const scopedValueWithLegacy = (
    ...
    scopedValue(
      elementId,
      property,
      scopedValue(legacyElementId, property, fallback, stateId),
      stateId,
    );
  const headerColor = scopedValueWithLegacy(
    "headerContainer",
    "header",
    "background",
    c.headerColor || V12_ORIGINAL_STYLE.headerColor,
  );
  const headerAccent = scopedValueWithLegacy(
    "headerContainer",
    "header",
    "accentColor",
    c.headerAccent || V12_ORIGINAL_STYLE.headerAccent,
  );
  const countCardColor = scopedValue(
    "card",
    "background",
    c.countCardColor || V12_ORIGINAL_STYLE.countCardColor,
  );
  const currentBonusColor = scopedValue(
    "highlight",
    "background",
    c.currentBonusColor || V12_ORIGINAL_STYLE.currentBonusColor,
  );
  const currentBonusAccent = scopedValue(
    "highlight",
    "accentColor",
    c.currentBonusAccent || V12_ORIGINAL_STYLE.currentBonusAccent,
  );
  const listCardColor = scopedValue(
    "bonusCard",
    "background",
    c.listCardColor || V12_ORIGINAL_STYLE.listCardColor,
  );
  const listCardAccent = scopedValue(
    "bonusCard",
    "accentColor",
    c.listCardAccent || V12_ORIGINAL_STYLE.listCardAccent,
  );
  const summaryColor = scopedValue(
    "value",
    "background",
    c.summaryColor || V12_ORIGINAL_STYLE.summaryColor,
  );
  const totalPayColor = scopedValue(
    "profit",
    "background",
    c.totalPayColor || V12_ORIGINAL_STYLE.totalPayColor,
  );
  const totalPayText = scopedValue(
    "profit",
    "textColor",
    c.totalPayText || V12_ORIGINAL_STYLE.totalPayText,
  );
  const superBadgeColor = scopedValue(
    "openedState",
    "accentColor",
    c.superBadgeColor || V12_ORIGINAL_STYLE.superBadgeColor,
  );
  const extremeBadgeColor = scopedValue(
    "loss",
    "accentColor",
    c.extremeBadgeColor || V12_ORIGINAL_STYLE.extremeBadgeColor,
  );
  const textColor = scopedValue(
    "bonusCard",
    "textColor",
    c.textColor || V12_ORIGINAL_STYLE.textColor,
  );
  const mutedTextColor = scopedValue(
    "label",
    "textColor",
    c.mutedTextColor || V12_ORIGINAL_STYLE.mutedTextColor,
  );
  const statValueColor = scopedValue(
    "value",
    "textColor",
    c.statValueColor || V12_ORIGINAL_STYLE.statValueColor,
  );
  const cardOutlineColor = scopedValue(
    "bonusCard",
    "borderColor",
    c.cardOutlineColor || V12_ORIGINAL_STYLE.cardOutlineColor,
  );
  const cardOutlineWidth = scopedValue(
    "bonusCard",
    "borderWidth",
    c.cardOutlineWidth ?? V12_ORIGINAL_STYLE.cardOutlineWidth,
  );
  const fontFamily = scopedValue(
    "container",
    "fontFamily",
    scopedValue(
      "bonusCard",
      "fontFamily",
      c.fontFamily || V12_ORIGINAL_STYLE.fontFamily,
    ),
  );
  const fontSize = scopedValue(
    "container",
    "fontSize",
    scopedValue(
      "bonusCard",
      "fontSize",
      c.fontSize ?? V12_ORIGINAL_STYLE.fontSize,
    ),
  );
  const cardRadius = scopedValue(
    "bonusCard",
    "radius",
    c.cardRadius ?? V12_ORIGINAL_STYLE.cardRadius,
  );
  const cardGap = scopedValue(
    "bonusCard",
    "gap",
    c.cardGap ?? V12_ORIGINAL_STYLE.cardGap,
  );
  const cardPadding = scopedValue(
    "bonusCard",
    "padding",
    c.cardPadding ?? V12_ORIGINAL_STYLE.cardPadding,
  );
  const slotImageHeight = scopedValue(
    "slotImage",
    "height",
    c.slotImageHeight ?? V12_ORIGINAL_STYLE.slotImageHeight,
  );
  ...
  const scopedStyle = (elementId, fallback = {}, stateId = "default") =>
    subElementStyle(explicitAppearanceConfig, elementId, fallback, stateId);
  const scopedStyleWithLegacy = (
    elementId,
    legacyElementId,
    fallback = {},
    stateId = "default",
    ...
    scopedStyle(
      elementId,
      scopedStyle(legacyElementId, fallback, stateId),
      stateId,
    );
  const headerContainerStyle = scopedStyleWithLegacy(
    "headerContainer",
    "header",
  );
  ...
  const slotCarouselContainerRawStyle = scopedStyleWithLegacy(
    "slotCarouselContainer",
    "carousel",
  );
  const [legacyCarouselBackdropStyle, slotCarouselContainerStyle] =
    splitStyleByKeys(slotCarouselContainerRawStyle, SURFACE_PAINT_STYLE_KEYS);
  const carouselBackdropStyle = scopedStyle(
    "carouselBackdrop",
    legacyCarouselBackdropStyle,
  );
  ...
  const slotListContainerStyle = scopedStyleWithLegacy(
    "slotListContainer",
    "bonusCard",
  );
  ...
  const footerContainerStyle = scopedStyleWithLegacy(
    "footerContainer",
    "footer",
  );
  const footerLabelStyle = scopedStyle("footerLabel");
  const footerTotalValueStyle = scopedStyleWithLegacy(
    "footerTotalValue",
    "footer",
  );
  ...
  const rootStyle = {
    ...scopedStyle("container", {
      ...
      background: composeV12RootBackground(
        headerColor,
        hasHeaderBackgroundOverride
          ? c.rootBackground
          : V12_ORIGINAL_STYLE.rootBackground,
      ),
      color: textColor,
    }),
    fontFamily,
    ...
    "--bht-progress-bg": subValue(
      c,
      "progressBar",
      "background",
      "rgba(255,255,255,0.08)",
    ),
    "--bht-progress-fill": subValue(
      c,
      "progressBar",
      "fillColor",
      currentBonusAccent,
  ...
  return (
    ...
    >
      ...
      <div
        className="bht-card bht-header bht-header--fullflip"
        {...partAttrs("headerContainer")}
        style={{ ...headerContainerStyle, flex: "0 0 auto" }}
      >
        <div
        ...
        >
          <div className="bht-fullflip-face bht-fullflip-front">
            <div className="bht-header-center">
              {c.avatarUrl ? (
                <img
                  ...
                  data-widget-element="headerIcon"
            ...
            <div
              className="bht-header-stats bht-header-stats--4col"
              {...partAttrs("mainStatsContainer")}
              style={mainStatsContainerStyle}
            >
              <div className="bht-flip-face bht-flip-front">
                <div
                  className="bht-stat-box"
                  {...partAttrs("statCell")}
                  style={statCellStyle}
                >
                  <div
                    className="bht-stat-label"
                    data-widget-element="statLabel"
                  ...
                  <div
                    ...
                    data-widget-element="statValue"
                    style={scopedStyle("statValue")}
                  >
                    {currency}
                ...
                >
                  ...
                  <div
                    ...
                    style={scopedStyle(
                      ...
                      stats.liveBE >= 100 ? "negative" : "positive",
                    )}
                  >
                ...
                >
                  ...
                  <div
                    ...
                    style={scopedStyle(
                      ...
                      stats.avgMulti >= 100 ? "positive" : "negative",
                    )}
                  >
            ...
            <div className="bht-flipback-layout">
              ...
              <div className="bht-flipback-side">
                <div className="bht-flipback-stats">
                  <div
                    className="bht-flipback-stat-label"
                    data-widget-element="winLabel"
                    style={winLabelStyle}
                  >
                    PAYOUT
                  </div>
                  <div
                    className="bht-flipback-stat-val"
                    data-widget-element="winValue"
                    style={scopedStyleWithLegacy(
                      "winValue",
                      "payoutValue",
                      { color: "#4ade80" },
                      "positive",
                  ...
                  >
                    {stats.bestSlot
                      ? `${currency}${stats.bestSlot._payout.toFixed(0)}`
                      : "—"}
                  </div>
                  <div
                    className="bht-flipback-stat-label"
                    data-widget-element="multiplierLabel"
                    style={multiplierLabelStyle}
                  >
                    MULTI
                  </div>
                  <div
                    className="bht-flipback-stat-val"
                    data-widget-element="multiplierValue"
                    style={multiplierValueStyle}
                  >
                    {stats.bestSlot
                  ...
                  <div
                    className="bht-flipback-stat-val"
                    data-widget-element="betValue"
                    style={betValueStyle}
                  >
                    {stats.bestSlot
                      ? `${currency}${(Number(stats.bestSlot.betSize) || 0).toFixed(2)}`
                      : "—"}
                  </div>
                </div>
                {stats.bestSlot ? (
                  <div className="bht-flipback-slot bht-flipback-slot--best">
                    {stats.bestSlot.slot?.image ? (
                      <SlotImage
                        ...
                        className="bht-flipback-slot-img"
                  ...
                  <div className="bht-flipback-slot bht-flipback-slot--empty">
                    —
                  </div>
                )}
              </div>
              ...
              <div className="bht-flipback-side">
                  ...
                  <div className="bht-flipback-slot bht-flipback-slot--worst">
                    {stats.worstSlot.slot?.image ? (
                      <SlotImage
                        ...
                        alt={
                          stats.worstSlot.slotName || stats.worstSlot.slot?.name
                        }
                        className="bht-flipback-slot-img"
                        data-widget-element="slotImage"
                        style={slotImageStyle}
                ...
                <div className="bht-flipback-stats">
                  ...
                  >
                    {stats.worstSlot
                      ? `${currency}${stats.worstSlot._payout.toFixed(0)}`
                      : "—"}
                  </div>
                  <div
                    className="bht-flipback-stat-label"
                  ...
                  >
                    {stats.worstSlot
                      ? `${currency}${(Number(stats.worstSlot.betSize) || 0).toFixed(2)}`
                      : "—"}
                  </div>
                </div>
              </div>
      ...
      {bonuses.length > 0 && (
        ...
        >
          ...
          >
            <div
              className="bht-stack-backdrop"
              {...partAttrs("carouselBackdrop")}
              style={carouselBackdropStyle}
            />
            {(() => {
          ...
          {(() => {
            ...
            return (
              <div className="bht-progress">
                <div
                  className="bht-progress-bar"
                  {...partAttrs("progressBar")}
                  style={progressBarStyle}
                >
                  <div
                    className="bht-progress-fill"
                    {...partAttrs("progressBarFill")}
                    style={{ ...progressBarFillStyle, width: `${pct}%` }}
                  />
                </div>
                <span
                  className="bht-progress-meta"
                  {...partAttrs("progressCount")}
                  style={progressCountStyle}
                >
                  {(stats.superCount > 0 || stats.extremeCount > 0) && (
                    <span
                      className="bht-progress-specials"
                      aria-label={`${stats.superCount} super bonuses and ${stats.extremeCount} extreme bonuses`}
                    >
                      {stats.superCount > 0 && (
                        <span
                          className="bht-progress-special bht-progress-special--super"
                          title="Super bonuses"
                        >
                          {stats.superCount}
                        </span>
                      ...
                      {stats.extremeCount > 0 && (
                        <span
                          className="bht-progress-special bht-progress-special--extreme"
                          title="Extreme bonuses"
                        >
                          {stats.extremeCount}
                        </span>
                      )}
          ...
          >
            ...
            {(() => {
                ...
                return (
                  <div key="lr-static" className="bht-list-rows-track">
                    {bonuses.map((bonus, i) => {
                      ...
                      const stateId = bonusRowState(i, currentIndex, bonus);
                      return (
                        <div
                          key={`lr-${bonus.id || i}-o`}
                        ...
                        >
                          <span
                            ...
                            data-widget-element="slotPositionNumber"
                            style={slotPositionNumberStyle}
                          >
                            {i + 1}
                          </span>
                          <div
                            className="bht-list-row-thumb"
                          ...
                          <div className="bht-list-row-info">
                            <span
                              className="bht-list-row-name"
                              data-widget-element="slotTitle"
                            ...
                            {bonus.requestedBy &&
                              bonus.requestedBy !== "anonymous" && (
                                <span
                                  className="bht-list-row-requester"
                                  data-widget-element="requestsDescription"
                                  style={requestsDescriptionStyle}
                                >
                                  by {bonus.requestedBy}
                                </span>
                              )}
                          </div>
                          <div
                            className="bht-list-row-stats"
                            {...partAttrs("rowStatsContainer")}
                            style={rowStatsContainerStyle}
                          >
                            <div className="bht-list-row-col">
                              <span
                                className="bht-list-row-col-label"
                                data-widget-element="winLabel"
                                style={winLabelStyle}
                              >
                                WIN
                              ...
                              <span
                                className="bht-list-row-col-val"
                                data-widget-element="winValue"
                                style={winValueStyle}
                              >
                                {currency}
              ...
              const renderRow = (bonus, idx, key) => {
                ...
                const bet = Number(bonus.betSize) || 0;
                const multi = bet > 0 ? payout / bet : 0;
                const stateId = bonusRowState(idx, currentIndex, bonus);
                return (
                  <div
                    key={key}
      ...
      {srVisible && (
        <div
          className={`bht-card bht-v12-sr bht-v12-sr--${srAnim}`}
          {...partAttrs("requestsSectionContainer")}
          style={{
            ...requestsSectionContainerStyle,
            flex:
              srAnim === "slide-down" || srAnim === "shrink-list"
                ? "0 0 0px"
                : "1 1 0",
            minHeight: 0,
            overflow: "hidden",
        ...
        >
          <div
            className="bht-v12-sr-header"
            data-widget-element="requestsHeader"
            style={requestsHeaderStyle}
          >
            <span className="bht-v12-sr-icon">🎰</span>
            <span
              className="bht-v12-sr-title"
              data-widget-element="requestsHeader"
              style={requestsHeaderStyle}
            >
              Slot Requests
            ...
            {srRequests.length > 0 && (
              <span
                className="bht-v12-sr-count"
                data-widget-element="tagContainer"
                style={{ ...tagContainerStyle, ...tagTextStyle }}
              >
                {srRequests.length}
              </span>
            )}
          ...
          <div className="bht-v12-sr-list" ref={srListRef}>
            ...
            {srRequests.length === 0 ? (
              <div
                className="bht-v12-sr-empty"
                data-widget-element="requestsEmpty"
                style={requestsEmptyStyle}
              >
                <span
                  className="bht-v12-sr-hint"
                  data-widget-element="requestsDescription"
                  style={requestsDescriptionStyle}
                >
                  Type{" "}
                  <strong>{c.commandTrigger || "!sr"} &lt;slot name&gt;</strong>{" "}
                  in chat to request a slot
                </span>
              </div>
            ) : (
              <div
                className={`sr-min-scroll-track${srNeedsScroll ? " sr-min-scroll-track--animate" : ""}`}
                style={
                  srNeedsScroll
                    ? {
                        "--sr-scroll-duration": `${Math.max(8, (srRequests.length * srScrollSpeed) / 3)}s`,
                      }
                    : undefined
                }
              >
                {[...(srNeedsScroll ? [0, 1] : [0])].map((setIdx) =>
                  srRequests.map((r, i) => (
                    <div
                      key={`${setIdx}-${r.id}`}
                      className="bht-v12-sr-row"
                      {...partAttrs("slotRow")}
                      style={scopedStyle("slotRow")}
                    >
                      <div
                        className="bht-v12-sr-row-bg"
                        style={{
                          backgroundImage: `url(${r.slot_image || FALLBACK_SR_IMG})`,
                        }}
                      />
                      <div className="bht-v12-sr-row-overlay" />
                      <div className="bht-v12-sr-row-content">
                        <span
                          className="bht-v12-sr-row-idx"
                          data-widget-element="slotPositionNumber"
                          style={slotPositionNumberStyle}
                        >
                          {i + 1}
                        ...
                        <SlotImage
                          src={r.slot_image || FALLBACK_SR_IMG}
                          alt={r.slot_name}
      ...
      {/* ═══ Total Pay Footer ═══ */}
      <div
        className="bht-card bht-footer"
        {...partAttrs("footerContainer")}
        style={{ ...footerContainerStyle, flex: "0 0 auto" }}
      >
        <div className="bht-footer-flip-wrap">
          ...
          >
            <div className="bht-footer-flip-face bht-footer-flip-front">
              <span
                className="bht-footer-label"
                data-widget-element="footerLabel"
              ...
              <span
                ...
                data-widget-element="footerTotalValue"
                style={footerTotalValueStyle}
              >
                {currency}
