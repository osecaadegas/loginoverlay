...
function BetterStyleSheet() {
  return (
    <style>{`
      ...
      .better-hunt-hstrip-list{min-width:0;min-height:0;display:grid;grid-template-rows:48px minmax(0,1fr);overflow:hidden;border-right:1px solid color-mix(in srgb,var(--bh-line-hi) 42%,transparent);padding:8px}.better-hunt-hstrip-list .better-hunt-list{height:100%;max-height:var(--bh-list-height)}
