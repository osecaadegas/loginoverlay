...
function BetterStyleSheet() {
  return (
    <style>{`
      ...
      .better-hunt-hstrip-slot-stats{height:190px;max-height:100%;align-self:center;display:grid;grid-template-columns:minmax(0,1.35fr) minmax(92px,.8fr);overflow:hidden;border:1px solid color-mix(in srgb,var(--bh-line-hi) 52%,transparent);border-radius:9px;background:var(--bh-inset)}
