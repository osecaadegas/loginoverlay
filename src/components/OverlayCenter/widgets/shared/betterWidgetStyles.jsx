...
function BetterStyleSheet() {
  return (
    <style>{`
      ...
      @keyframes better-hunt-drawer-in{from{max-height:0;opacity:0;transform:translateY(-12px)}to{max-height:var(--bh-drawer-open-height,150px);opacity:1;transform:translateY(0)}}
