...
function BetterStyleSheet() {
  return (
    <style>{`
      ...
      .better-hunt-hstrip-slot-art{position:relative;min-height:0;display:grid;place-items:center;overflow:hidden;background:var(--bh-inset)}.better-hunt-hstrip-slot-art img{width:100%;height:100%;max-width:126px;max-height:154px;display:block;object-fit:cover;object-position:center}.better-hunt-hstrip-slot-art::after{content:"";position:absolute;inset:0;background:linear-gradient(180deg,transparent 35%,rgba(0,0,0,.92));pointer-events:none}.better-hunt-hstrip-slot-art strong{position:absolute;left:10px;right:10px;bottom:8px;z-index:1;overflow:hidden;color:#fff;font-size:1em;font-weight:950;text-overflow:ellipsis;text-transform:uppercase;white-space:nowrap;text-shadow:0 2px 5px #000}
