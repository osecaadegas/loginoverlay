              ...
              {stats.bestSlot ? (
                <div className="bht-fullflip-slot bht-fullflip-slot--best">
                  <div className="bht-fullflip-slot-ribbon bht-fullflip-slot-ribbon--best">
                    <span className="bht-fullflip-slot-ribbon-icon">▲</span> BEST
                  </div>
                  <div className="bht-fullflip-slot-img-area">
                  ...
                  <div className="bht-fullflip-slot-info">
                    <div className="bht-fullflip-slot-name">{stats.bestSlot.slotName || stats.bestSlot.slot?.name || '—'}</div>
                    <div className="bht-fullflip-slot-stats-row">
                      <div className="bht-fullflip-slot-stat">
                        <span className="bht-fullflip-slot-payout bht-fullflip-slot-payout--best">{currency}{stats.bestSlot._payout.toFixed(2)}</span>
                      </div>
                      <div className="bht-fullflip-slot-stat">
              ...
              {stats.worstSlot ? (
                <div className="bht-fullflip-slot bht-fullflip-slot--worst">
                  <div className="bht-fullflip-slot-ribbon bht-fullflip-slot-ribbon--worst">
                    <span className="bht-fullflip-slot-ribbon-icon">▼</span> WORST
                  </div>
                  <div className="bht-fullflip-slot-img-area">
                  ...
                  <div className="bht-fullflip-slot-info">
                    <div className="bht-fullflip-slot-name">{stats.worstSlot.slotName || stats.worstSlot.slot?.name || '—'}</div>
                    <div className="bht-fullflip-slot-stats-row">
                      <div className="bht-fullflip-slot-stat">
                        <span className="bht-fullflip-slot-payout bht-fullflip-slot-payout--worst">{currency}{stats.worstSlot._payout.toFixed(2)}</span>
                      </div>
                      <div className="bht-fullflip-slot-stat">
