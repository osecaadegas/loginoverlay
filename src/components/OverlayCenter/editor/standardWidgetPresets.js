export const STANDARD_BETTER_WIDGET_GEOMETRY = Object.freeze({
  ...
  tournament: { x: 4, y: 69.36370849609375, width: 960, height: 720, zIndex: 28 },
  navbar: { x: 0, y: 0, width: 1915, height: 72, zIndex: 10 },
  rtp_stats: { x: 331.1822509765625, y: 760.54541015625, width: 1245, height: 57, zIndex: 20 },
  slideshow_frame: { x: 1580.5455932617188, y: 64.45452880859375, width: 336, height: 227, zIndex: 25 },
  bonus_hunt: { x: -18, y: 49, width: 369, height: 884, zIndex: 30 },
  bets: { x: 260, y: 800, width: 778, height: 300, zIndex: 40 },
  chat: { x: 1580.5455932617188, y: 313.5455322265625, width: 218, height: 457, zIndex: 50 },
  giveaway: { x: 1557.7272338867188, y: 800, width: 420, height: 270, zIndex: 60 },
  raid_shoutout: { x: 680, y: 330, width: 560, height: 420, zIndex: 70 },
});
