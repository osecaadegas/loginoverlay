...
const ICONS = {
  ...
  detector: 'M12 2l8 4v6c0 5-3.4 9.7-8 11-4.6-1.3-8-6-8-11V6l8-4zm0 3.2L7 7.7V12c0 3.2 2 6.4 5 7.6 3-1.2 5-4.4 5-7.6V7.7l-5-2.5zM9 11h6v2H9v-2zm0 4h4v2H9v-2z',
  ...
  return (
    <aside className={`sb ${className}`}>
      ...
      <nav className="sb-nav">
        ...
        {(isAdmin || isPremium || isModerator) && (
          <NavItem icon={ICONS.detector} labelKey="nav_slot_detector" label="Slot Detector" path="/slot-detector" />
        )}
