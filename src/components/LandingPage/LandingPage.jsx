      ...
      <div className="lp-root">
          ...
          <div className="lp-hero-inner">
            ...
            <div className="lp-hero-copy">
              ...
              <div className="lp-socials">
                {[
                  { href: 'https://www.twitch.tv/osecaadegas95',   path: 'M11.571 4.714h1.715v5.143H11.57zm4.715 0H18v5.143h-1.714zM6 0L1.714 4.286v15.428h5.143V24l4.286-4.286h3.428L22.286 12V0zm14.571 11.143l-3.428 3.428h-3.429l-3 3v-3H6.857V1.714h13.714Z' },
                  { href: 'https://www.youtube.com/@osecaadegas',  path: 'M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z' },
                  { href: 'https://discord.gg/4yZ3F2Pk4z',         path: 'M20.317 4.37a19.791 19.791 0 0 0-4.885-1.515.074.074 0 0 0-.079.037c-.21.375-.444.864-.608 1.25a18.27 18.27 0 0 0-5.487 0 12.64 12.64 0 0 0-.617-1.25.077.077 0 0 0-.079-.037A19.736 19.736 0 0 0 3.677 4.37a.07.07 0 0 0-.032.027C.533 9.046-.32 13.58.099 18.057a.082.082 0 0 0 .031.057 19.9 19.9 0 0 0 5.993 3.03.078.078 0 0 0 .084-.028 14.09 14.09 0 0 0 1.226-1.994.076.076 0 0 0-.041-.106 13.107 13.107 0 0 1-1.872-.892.077.077 0 0 1-.008-.128 10.2 10.2 0 0 0 .372-.292.074.074 0 0 1 .077-.01c3.928 1.793 8.18 1.793 12.062 0a.074.074 0 0 1 .078.01c.12.098.246.198.373.292a.077.077 0 0 1-.006.127 12.299 12.299 0 0 1-1.873.892.077.077 0 0 0-.041.107c.36.698.772 1.362 1.225 1.993a.076.076 0 0 0 .084.028 19.839 19.839 0 0 0 6.002-3.03.077.077 0 0 0 .032-.054c.5-5.177-.838-9.674-3.549-13.66a.061.061 0 0 0-.031-.03zM8.02 15.33c-1.183 0-2.157-1.085-2.157-2.419 0-1.333.956-2.419 2.157-2.419 1.21 0 2.176 1.096 2.157 2.42 0 1.333-.956 2.418-2.157 2.418zm7.975 0c-1.183 0-2.157-1.085-2.157-2.419 0-1.333.955-2.419 2.157-2.419 1.21 0 2.176 1.096 2.157 2.42 0 1.333-.946 2.418-2.157 2.418z' },
                ].map(s => (
                  <a key={s.href} href={s.href} target="_blank" rel="noopener noreferrer" className="lp-social-btn">
              ...
              <div className="lp-mockup">
                <div className="lp-mockup-inner">
                  ...
                  <div className="lp-mock-reels">
                    {['7', '🍒', '7'].map((r, i) => (
                      <div key={i} className="lp-mock-reel">{r}</div>
                    ))}
                  </div>
                  {/* Mini charts row */}
                  <div className="lp-mock-stats">
                    <div className="lp-mock-stat">
                      <span className="lp-mock-stat-val" style={{ color: '#0ea5e9' }}>2.4k</span>
                      <span className="lp-mock-stat-lbl">Live Viewers</span>
                      <span className="lp-mock-stat-trend">▲ 12%</span>
                    </div>
                    <div className="lp-mock-divider" />
                    <div className="lp-mock-stat">
                      <span className="lp-mock-stat-val" style={{ color: '#10b981' }}>87</span>
                      <span className="lp-mock-stat-lbl">Conversions</span>
                      <span className="lp-mock-stat-trend">▲ 5%</span>
                    </div>
                    <div className="lp-mock-divider" />
                    <div className="lp-mock-stat">
                      <span className="lp-mock-stat-val" style={{ color: '#f59e0b' }}>€1,250</span>
                      <span className="lp-mock-stat-lbl">Revenue</span>
                      <span className="lp-mock-stat-trend">▲ 34%</span>
                    </div>
                  </div>
                  {/* Mini progress bars */}
                  <div className="lp-mock-bars">
                    {[{ w: '82%', c: '#6366f1', lbl: 'Overlay CTR' }, { w: '61%', c: '#0ea5e9', lbl: 'Conversion' }, { w: '45%', c: '#10b981', lbl: 'Retention' }].map(b => (
              ...
              <div className="lp-account-panel">
                <div className="lp-acct-header">
                  ...
                  <div>
                    ...
                    {user && <div className="lp-acct-expire">Expires Dec 31, 2026</div>}
                  </div>
                </div>
                ...
                <button
                  className="lp-btn-primary lp-acct-cta"
        ...
        <section className="lp-stats">
          {[
            ...
            { label: 'Affiliate Revenue Generated', end: 48000, suffix: '+',  prefix: '€', icon: '💶' },
            { label: 'Partner Brands',              end: 15,    suffix: '+',  prefix: '',  icon: '🤝' },
            { label: 'Premium Support',             end: 24,    suffix: '/7', prefix: '',  icon: '🎧' },
          ].map(s => (
        ...
        <section className="lp-section">
          <div className="lp-section-top">
            ...
            <button className="lp-link-btn" onClick={() => navigate('/offers')}>View all partners →</button>
          </div>
            ...
            {partners.map((p, i) => {
              ...
              return (
                <div key={fp.id} className="lp-partner-card" style={{ '--acc': fp.accent }}>
                  ...
                  <button className="lp-partner-btn" onClick={() => p.bonus_link ? handleOfferClick(p) : navigate('/offers')}>
                    Apply Now
                  </button>
                </div>
              );
        ...
        <section className="lp-section lp-two-col">
          ...
          <div className="lp-market">
            <div className="lp-section-top">
              ...
              <button className="lp-link-btn" onClick={() => navigate('/offers')}>View all offers →</button>
            </div>
            ...
            <div className="lp-filters">
              {FILTERS.map(f => (
                <button
                  key={f}
                  className={`lp-filter ${activeFilter === f ? 'lp-filter--on' : ''}`}
              ...
              {MARKETPLACE.map(m => (
                <div key={m.name} className="lp-market-item" style={{ '--mc': m.color }}>
                  ...
                  <div className="lp-market-right">
                    ...
                    <button className="lp-market-btn" onClick={() => navigate('/offers')}>Apply Now</button>
                  </div>
                </div>
              ))}
            </div>
