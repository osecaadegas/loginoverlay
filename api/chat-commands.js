...
import { slotRequestHandler, streamElementsConnectionHandler } from "./_lib/slot-request-runtime.js";
...
export default async function handler(req, res) {
  ...
  switch (cmd) {
    ...
    case "sr-reject":
    case "sr-clear-all":
      return slotRequestHandler(req, res, { lookupTwitchUser: findTwitchUserId });
    case "se-connection":
      return streamElementsConnectionHandler(req, res);
    case "song":
